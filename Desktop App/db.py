...
class sqlite3DB(object):
    ...
    def getLastRow(self):
        ...
        self.cursor.execute('SELECT "temperature", "pressure", "light_intensity", "humidity", "wind_speed", "wind_direction", "timestamp" FROM "weather_records" ORDER BY id DESC LIMIT 1')
    ...
    def insert(self, data):
        ...
        # Insert to db
        self.cursor.execute('INSERT INTO "weather_records" ("sensor_id", "station_id", "temperature", "pressure", "light_intensity", "humidity", "wind_speed", "wind_direction", "timestamp") VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)', data)
        # Commit changes
        self.commit()
